...
import { UpdatingElementMixin } from './lib/updating-element.js';
...
export const LitElementMixin = function (superclass) {
    var _a;
    /**
     ...
     */
    return _a = class extends UpdatingElementMixin(superclass) {
            /**
