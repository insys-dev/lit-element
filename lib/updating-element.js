...
export const UpdatingElementMixin = function (superclass) {
    var _a, _b;
    /**
    ...
    return _b = class extends superclass {
            ...
            performUpdate() {
                ...
                if (shouldUpdate) {
                    ...
                    if (!(useBufferTime && isFirstUpdate))
                        this.updated(changedProperties);
                }
            }
            /** @private */
...
export class UpdatingElement extends UpdatingElementMixin(HTMLElement) {
}
