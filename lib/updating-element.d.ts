...
declare const STATE_HAS_UPDATED = 1;
declare const STATE_UPDATE_REQUESTED: number;
declare const STATE_IS_REFLECTING_TO_ATTRIBUTE: number;
declare const STATE_IS_REFLECTING_TO_PROPERTY: number;
declare type UpdateState = typeof STATE_HAS_UPDATED | typeof STATE_UPDATE_REQUESTED | typeof STATE_IS_REFLECTING_TO_ATTRIBUTE | typeof STATE_IS_REFLECTING_TO_PROPERTY;
/**
...
export declare const UpdatingElementMixin: (superclass: typeof HTMLElement) => {
    new (): {
        /** @private */
        ...
        /** @private */
        _propertyToAttribute(name: PropertyKey, value: unknown, options?: PropertyDeclaration): void;
        /** @private */
     ...
     * @protected
     */
    getPropertyDescriptor(name: PropertyKey, key: string | symbol, options: PropertyDeclaration): {
        get(): any;
     ...
     * @private
     */
    _attributeNameForProperty(name: PropertyKey, options: PropertyDeclaration): string | undefined;
    /**
     ...
     * @private
     */
    _propertyValueFromAttribute(value: string | null, options: PropertyDeclaration): unknown;
    /**
     ...
     * @private
     */
    _propertyValueToAttribute(value: unknown, options: PropertyDeclaration): unknown;
    /**
     * @protected
